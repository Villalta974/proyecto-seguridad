...
(function(b) { "function" === typeof define && define.amd ? define(["jquery", "datatables.net", "datatables.net-buttons"], function(d) { return b(d, window, document) }) : "object" === typeof exports ? module.exports = function(d, h) { d || (d = window);
    ...
    u.ext.buttons.print = {
        ...
        action: function(a, e, p, k) {
            ...
            } else e.buttons.info(e.i18n("buttons.printErrorTitle", "No se puede abrir la vista previa"), e.i18n("buttons.printErrorMsg", "Por favor, permita ventanas emergentes en su navegador para que este sitio pueda ver la vista de impresión."), 5E3)
        },
        title: "*",
        messageTop: "*",
        messageBottom: "*",
